...
*** Server machine configuration
    ...
    - We use the following configuration on server machine
...
*** Client machine configuration     
    - We use the following configuration on client machine
      + CPU op-mode(s) - 64-bit 
      + No. of courses - 4
...
** Memory used for the above mentioned labs 
   ...
   - Free RAM in the below data defines, the available memory
     after the usage of lab performed by no.of users.
