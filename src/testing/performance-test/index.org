...
*** Test Case-001: Performance stats when 32GB RAM on College Cloud Server
    ...
    |       |                     |            |                    | Lab                  |
    |-------+---------------------+------------+--------------------+----------------------|
    |   100 | Free RAM in MB      | 1100       | 1240               | 1096                 |
    |       | CPU utilization (%) | 5          | 12                 | 15                   |
    |       | vmstat              | [[./test-case2/32gb/vmstat-100-users-cse14.txt][raw-data]]   | [[./test-case2/32gb/vmstat-100-users-pc.txt][raw-data]]           | [[./test-case2/32gb/vmstat-100-users-cp.txt][raw-data]]             |
    ...
    |-------+---------------------+------------+--------------------+----------------------|
    |   200 | Free RAM in MB      | 1127       | 1234               | 1108                 |
    |       | CPU utilization     | 7          | 16                 | 9                    |
    |       | vmstat              | [[./test-case2/32gb/vmstat-200-users-cse14.txt][raw-data]]   | [[./test-case2/32gb/vmstat-200-users-pc.txt][raw-data]]           | [[./test-case2/32gb/vmstat-200-users-cp.txt][raw-data]]             |
    ...
    |-------+---------------------+------------+--------------------+----------------------|
    |   300 | Free RAM in MB      | 1099       | 1240               | 1118                 |
    |       | CPU utilization     | 9          | 9                  | 9                    |
    |       | vmstat              | [[./test-case2/32gb/vmstat-300-users-cse14.txt][raw-data]]   | [[./test-case2/32gb/vmstat-300-users-pc.txt][raw-data]]           | [[./test-case2/32gb/vmstat-300-users-cp.txt][raw-data]]             |
...
*** Test Case -002: Performance stats when  16GB RAM on College Cloud Server
    ...
    |       | CPU utilization |            |                    |                           |
    |       | vmstat          | [[./test-case2/16gb/vmstat-100-users-cse14.txt][raw-data]]   | [[./test-case2/16gb/vmstat-100-users-pc.txt][raw-data]]           | [[./test-case2/16gb/vmstat-100-users-cp.txt][raw-data]]                  |
    ...
    |-------+-----------------+------------+--------------------+---------------------------|
    |   200 | Free RAM in MB  |            | 29827              | 29161                     |
    |       | CPU utilization |            |                    |                           |
    |       | vmstat          | [[./test-case2/16gb/vmstat-200-users-cse14.txt][raw-data]]   | [[./test-case2/16gb/vmstat-200-users-pc.txt][raw-data]]           | [[./test-case2/16gb/vmstat-200-users-cp.txt][raw-data]]                  |
    ...
    |       | CPU utilization |            |                    |                           |
    |       | vmstat          | [[./test-case2/16gb/vmstat-300-users-cse14.txt][raw-data]]   | [[./test-case2/16gb/vmstat-300-users-pc.txt][raw-data]]           | [[./test-case2/16gb/vmstat-300-users-cp.txt][raw-data]]                  |
