...
Collge cloud will not work 8GB RAM or below 8GB RAM.

Reason: Only vagrant box (edx platfrom) takes 8GB RAM, So we are not able to run vagrant box (edx platform).
